  1. first i install the json package with npm init -y

  2. then i install the express port which i will run on nodejs
  3. then we have to downloaded the ejs and mongoose which we have to set up
  4. now we have to show the databases which we right now using the mongoodb


  5. first prompt is show dbs to show all of the dbs

  6. then we have to create a folder of models and there we can create a listing.js: inside there we can set the constraint rules of nodejs and requiremongoose and schema rules on there.
  ...
  we can change the search button .
